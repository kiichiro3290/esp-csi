...
static const uint8_t CONFIG_CSI_SEND1_MAC[] = {0x1a, 0x00, 0x00, 0x00, 0x00, 0x00};
static const uint8_t CONFIG_CSI_SEND2_MAC[] = {0x1a, 0x1a, 0x00, 0x00, 0x00, 0x00};
...
static void wifi_init()
{
    ...
    ESP_ERROR_CHECK(esp_wifi_set_mac(WIFI_IF_STA, CONFIG_CSI_SEND1_MAC));
}
...
static void wifi_csi_rx_cb(void *ctx, wifi_csi_info_t *info)
{
    ...
    if (memcmp(info->mac, CONFIG_CSI_SEND1_MAC, 6) && memcmp(info->mac, CONFIG_CSI_SEND2_MAC, 6))
    {
        return;
    }
